    ...
    render() {
        return(
           <div className="gallery-type">
              <div className="gallery-type__container">
                  <div>
                      <svg aria-label="Posts" className="_8-yf5 " fill="#262626" height="12" viewBox="0 0 48 48" width="12">
                          <path
                  ...
                  <div>
                      <svg aria-label="Tagged" className="_8-yf5 " fill="#8e8e8e" height="12" viewBox="0 0 48 48"
                           width="12">
                          <path
